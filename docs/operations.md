...
`beacon-sim-infection-stack` is centered on simulations work in C#. The technical target is: Create a C# reference implementation for infection workflows, centered on security rule linting, safe and unsafe fixtures, and remediation hints.
...
The score is deterministic. The current threshold is 179. Risk has a penalty of 4, latency has a penalty of 3, and weight contributes a bonus of 3.
