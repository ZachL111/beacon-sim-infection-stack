"""Regression checks for the beacon-sim-infection-stack casebook."""
...
from casebook.harness import assert_expected, beacon_sim_infection_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(beacon_sim_infection_stack_summary(), assert_expected())
